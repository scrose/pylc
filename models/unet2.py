...
class decoding_block(nn.Module):
    ...
    def forward(self, input1, input2):
        ...
        output1 = nn.functional.interpolate(input1, size=output2.size()[2:], mode='bilinear', align_corners=True)
...
class UNet2(nn.Module):
    ...
    def forward(self, input):
        ...
        # final
        final = nn.functional.interpolate(self.final(decode1), size=input.size()[2:], mode='bilinear', align_corners=True)
